...
#   filename:  SpaceTraders.json
#   timestamp: 2024-07-19T20:03:38+00:00
...
class Agent(BaseModel):
    ...
    symbol: str = Field(
        ..., description="Symbol of the agent.", max_length=14, min_length=3
    )
    headquarters: str = Field(
        ..., description="The headquarters of the agent.", min_length=1
    )
    credits: int = Field(
        ...,
...
class ShipFuel(BaseModel):
    current: int = Field(
        ..., description="The current amount of fuel in the ship's tanks.", ge=0
    )
    capacity: int = Field(
        ..., description="The maximum amount of fuel the ship's tanks can hold.", ge=0
    )
...
class Chart(BaseModel):
    waypoint_symbol: Optional[WaypointSymbol] = Field(
        None,
        alias="waypointSymbol",
    )
...
class Contract(BaseModel):
    id: str = Field(..., description="ID of the contract.", min_length=1)
    ...
    deadline_to_accept: Optional[AwareDatetime] = Field(
        None,
...
class Faction(BaseModel):
    ...
    description: str = Field(
        ..., description="Description of the faction.", min_length=1
    )
    headquarters: str = Field(
        ...,
...
class RegisterNewAgentResponse(BaseModel):
